...
// ---------------------------------------------------------------------------
const V = (token, label) => ({ token, label });
...
// ─────────────────────────── helpers ───────────────────────────
export const byKey = (k) => NOTIFICATIONS.find((n) => n.key === k);
export const AUDIENCE_ORDER = ['owner', 'staff', 'customer', 'vendor', 'tenant'];
...
export function applyTokens(tpl, vars) {
