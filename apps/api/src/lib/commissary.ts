...
export function prepCostPerUnit(recipe: { total_cost?: number | null; yield_qty?: number | null }): number {
...
export function rawCostPerUnit(ing: { price_per_unit?: number | null; waste_percent?: number | null }): number {
...
// commissary default.
export function effectiveMarkup(itemMarkup: number | null | undefined, defaultMarkup: number): number {
