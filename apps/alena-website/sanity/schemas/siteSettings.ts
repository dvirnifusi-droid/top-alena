...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      name: "whatsapp",
      title: "וואטסאפ (E.164, למשל +972503962976)",
      type: "string",
      initialValue: "+972503962976",
    }),
    defineField({
      name: "address",
      title: "כתובת",
      type: "string",
      initialValue: "רוטשילד 104, ראשון לציון",
    }),
    defineField({ name: "addressLat", title: "Lat", type: "number" }),
    defineField({ name: "addressLng", title: "Lng", type: "number" }),
    defineField({
      name: "ontopoUrl",
      title: "OnTopo URL — הזמנת שולחנות",
      type: "url",
    ...
    defineField({
      ...
      title: "Instagram",
      type: "url",
      initialValue: "https://instagram.com/alena.hamara",
    }),
    defineField({ name: "facebookUrl", title: "Facebook", type: "url" }),
    defineField({
      name: "spotifyPlaylistUrl",
      title: "Spotify — קישור פלייליסט מלא",
      description:
