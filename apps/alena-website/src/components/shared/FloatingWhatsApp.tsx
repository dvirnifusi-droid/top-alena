...
export function FloatingWhatsApp() {
  ...
  useEffect(() => {
    // Show after a small scroll so the user is engaged
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 left-6 z-40 hidden h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-2xl shadow-charcoal/30 transition md:flex ${
