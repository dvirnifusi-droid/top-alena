...
export const metadata = pageMetadata({
  ...
  description:
    "מארגנים אירוע פרטי? עלינא ברוטשילד 104 — אולם פרטי עד 50 אורחים, אירועי חוץ וקייטרינג, מנות שף ים-תיכוניות מתנור ג׳וספר 600°, ברים מלאים, כשר בשרי. סוכן AI חכם יבנה לכם הצעה ב-2 דקות.",
  path: "/events",
});
...
const eventTypes = [
  ...
  {
    title: "בר ובת מצווה",
    desc: "חגיגה כשרה עם תפריט בשרים אמיתי, לא מפלסטיק. ההורים נושמים, הילד מצטלם.",
    icon: "✡️",
  },
  {
  ...
  {
    title: "אירועי חוץ · קייטרינג",
    desc: "אנחנו יוצאים גם אליכם — לאולמות, לחצרות, למשרדים. צוות מקצועי, ציוד עצמאי, ותפריט בשרי כשר באותה רמה כמו במסעדה.",
    icon: "🚚",
  },
];
...
const included = [
  ...
  },
  {
    ...
    desc: "תפריט בשרי כשר בלבד, מותאם אישית לכל אירוע. הכל יוצא מתנור הג׳וספר 600° — מהבשרים ועד הירקות הצלויים.",
  },
  {
    title: "ברים מלאים",
  ...
  {
    title: "כשרות",
    desc: "המקום כשר בשרי בלבד — לא פרווה, לא חלבי. כל האורחים נכנסים בשקט נפשי, ללא הפתעות.",
  },
  {
    title: "אירועי חוץ",
    desc: "אנחנו לא רק במסעדה — מגיעים אליכם הביתה, לחצר, לאולם או למשרד. אותו צוות, אותו תפריט.",
  },
];
