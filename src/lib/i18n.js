...
const DICT = {
  ...
  events_subtitle: {
    he: 'ספרו לי על האירוע — אסביר, אציע מחיר ואחזיר אישור מהיר',
    ar: 'أخبرني عن الفعالية — سأشرح، أقترح سعراً وأعطي تأكيداً سريعاً',
    en: 'Tell me about the event — I\'ll quote, explain, and confirm quickly',
    ru: 'Расскажите о мероприятии — я объясню, предложу цену и быстро подтвержу',
  },
