...
const DICT = {
  ...
  events_subtitle: {
    he: 'דנה, מנהלת האירועים, אוספת ממך פרטים — דביר יחזור אליך אישית',
    ar: 'دانا، مديرة الفعاليات، تجمع منك التفاصيل — دفير سيعاود الاتصال شخصياً',
    en: 'Dana, our events manager, collects your details — Dvir will get back personally',
    ru: 'Дана, менеджер мероприятий, соберёт детали — Двир свяжется лично',
  },
