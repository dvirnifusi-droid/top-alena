      ...
      <Card className="hover:shadow-lg transition-all cursor-pointer hover:scale-[1.02]">
        <CardContent className="p-5">
          <div className="flex items-center justify-between mb-3">
            <div className="p-2.5 bg-blue-100 rounded-xl"><Truck className="w-5 h-5 text-blue-600" /></div>
          ...
          {!loading && (
            <div className="flex gap-3 mt-2">
              ...
              <span className="text-xs text-blue-600 flex items-center gap-1"><Truck className="w-3 h-3" />{data.inProgress} בדרך</span>
            </div>
          )}
        </CardContent>
      </Card>
