            ...
            <Card className="mb-4 rounded-2xl border border-[#EADFC8] bg-white/95">
                <CardContent className="p-3 flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                        <p className="font-bold text-[#3A2E1E] text-sm leading-tight">הפעילו יעד משמרת</p>
                        <p className="text-gray-500 text-xs">יעד מכירה → הצוות מתחרה על הפרסים.</p>
                    </div>
                    <Button size="sm" className="flex-shrink-0" onClick={() => setShowActivate(true)}><Plus className="w-4 h-4 ml-1" /> הפעל</Button>
                </CardContent>
