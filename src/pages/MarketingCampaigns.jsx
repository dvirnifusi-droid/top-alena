...
const SEGMENTS = [
    ...
    },
    {
        ...
        desc: 'ציון מיוחד (חתונה / יום נישואין) החודש',
        defaultTemplate: 'היי {name} 💝\nהחודש יש לך ציון חשוב לחגוג. למה לא לחגוג איתנו?\nהזמן שולחן ותקבל מתנה אישית מבית {brand} 🌿',
        color: 'rose',
    },
    {
    ...
    },
    {
        ...
        defaultTemplate: 'היי {name}, מתגעגעים! ❤️\nכבר {days_since_visit} ימים מאז שביקרת אצלנו. הקפה הראשון על {brand} — בוא נראה אותך השבוע 🌿',
        color: 'amber',
    },
    {
        key: 'winback_60',
    ...
    },
    {
        ...
        emoji: '🏆',
        label: 'VIP בלבד',
        desc: 'לקוחות שסומנו VIP ידנית (סטטוס, לא דרגת ביקורים)',
    ...
    },
    {
        ...
        emoji: '🥇',
        label: 'דרגת זהב',
        desc: 'הדרגה הגבוהה בכרטיס החבר (25+ ביקורים או 300+ מטבעות)',
        defaultTemplate: 'היי {name} 🥇\nאתה בדרגת הזהב שלנו — הלקוחות שהכי אוהבים אותנו. הכנו לך משהו מיוחד, בוא ותהנה 🌿',
        color: 'gold',
    },
    {
        key: 'silver',
        emoji: '🥈',
        label: 'דרגת כסף',
        desc: 'הדרגה האמצעית בכרטיס החבר (10+ ביקורים או 100+ מטבעות)',
        defaultTemplate: 'היי {name} 🥈\nאתה בדרגת הכסף — עוד קצת ותגיע לזהב עם הטבות גדולות יותר. נשמח לראותך שוב 🌿',
        color: 'slate',
    },
    {
        key: 'high_spenders',
    ...
    },
    {
        ...
        defaultTemplate: 'היי {name} 👋\nראינו שחסרים לנו כמה פרטים שלך במועדון הלקוחות של {brand} — מגיע לך להתחיל לצבור הטבות! 🎁\nההשלמה לוקחת חצי דקה:\n{update_link}\n\nלהסרה מרשימת התפוצה — השיבו "הסר" 🌿',
        color: 'amber',
    },
    {
        key: 'manual',
