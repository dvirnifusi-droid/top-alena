...
define('ALENA_DZ_VERSION', '0.95.18');
...
require_once ALENA_DZ_PATH . 'includes/class-features.php';
require_once ALENA_DZ_PATH . 'includes/class-brands.php';
require_once ALENA_DZ_PATH . 'includes/class-order-landing.php';
require_once ALENA_DZ_PATH . 'includes/class-zohara-import.php';
...
add_action('plugins_loaded', function () {
    ...
    new Alena_DZ_Combos();
    new Alena_DZ_Features();
    new Alena_DZ_Brands();
    new Alena_DZ_Order_Landing();
    new Alena_DZ_Zohara_Import();
